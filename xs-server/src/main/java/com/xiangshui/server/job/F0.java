...
public class F0 {
    ...
    public void doWork(InputStream inputStream, String sheetName) throws IOException {
        ...
        data.forEach(new Consumer<List<String>>() {
            @Override
            public void accept(List<String> strings) {
                log.debug("{} {} {}", strings.get(0), strings.get(1), strings.get(2));
                try {
                    long booking_id = Long.valueOf(strings.get(0));
                    int final_price = Integer.valueOf(strings.get(1)) * 100;
                    int from_bonus = Integer.valueOf(strings.get(1)) * 100;
                    ...
                    booking.setFrom_bonus(from_bonus);
                    booking.setF0(1);
